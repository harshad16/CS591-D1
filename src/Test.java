...
public class Test {
	...
	public void runTest() {
        ...
        Course c1 = new Course("intro to programming", "the very first Course", "something", "something", null, null, null, null);
        Course c2 = new Course("intro to programming2", "the very first course2", null, null, null, null, null, null);
        Course c3 = new Course("course1", null, null, "tu-tr", null, null, null, null);
        Course c4 = new Course("course2", "about programming", "9:00-10:45 am", "mondays-wednesday", null, null, null, null);
        Course c5 = new Course("course3", "about memory models", "9:00-10:45 am", null, null, null, null, null);
        Course c6 = new Course("course4", "advanced course in javs", null, null, null, null, null, null);
        Course c7 = new Course("course4", null, "9:00-10:45 am", "mondays-wednesday", null, null, null, null);
